...
%Load in top aponeuroses that have also been cropped and resized
pxds = pixelLabelDatastore('Z:\Dropbox (GaTech)\RF\RF_US_DL\Data\Resized\Masks\TopApo\*.tif',classNames,labelIDs);
...
TopNet = trainNetwork(pximds_train,lgraph2,options);

%% Save trained network
save('Z:\Dropbox (GaTech)\RF\RF_US_DL\TrainedModels\TopNet.mat','TopNet')

%% Save train and test set objects for any future re-evaluations
save('C:\Users\pawel\Dropbox (GaTech)\RF\RF_US_DL\TrainedModels\TopNet_trainset.mat','pximds_train')
save('C:\Users\pawel\Dropbox (GaTech)\RF\RF_US_DL\TrainedModels\TopNet_testset.mat','pximds_test')
...
pxdsResults = semanticseg(imdsTest,TopNet,'MiniBatchSize',2,"WriteLocation",tempdir);
...
% 
%        0.99822          0.96238       0.94338      0.99651        0.99887  
